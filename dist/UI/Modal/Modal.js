...
var OnClickOutsideWrapper = /*#__PURE__*/function (_Component) {
  _inherits(OnClickOutsideWrapper, _Component);

  var _super = _createSuper(OnClickOutsideWrapper);
...
var Modal = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/_react.default.createElement(ModalOnClickOutsideWrapper, {
        handleClickOutside: this.onCloseButtonClick
      }, children)), showCloseButton && /*#__PURE__*/_react.default.createElement("span", {
