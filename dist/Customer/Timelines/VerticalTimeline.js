...
var VerticalTimeline = function VerticalTimeline(_ref2) {
    ...
    return _react.default.createElement(
        ...
        isLoading && _react.default.createElement('p', null, 'Loading...'),
        !isLoading &&
                                                ...
                                                _react.default.createElement(
                                                    ...
                                                    _react.default.createElement(_reactCountdownNow.default, {
                                                        ...
                                                        renderer: function renderer(_ref3) {
                                                            ...
                                                            var result = (0, _reactCountdownNow.formatTimeDelta)(
                                                                (0, _reactCountdownNow.calcTimeDelta)(
                                                            ...
                                                            _react.default.createElement(
                                                                ...
                                                                _react.default.createElement(
                                                                    ...
                                                                    _react.default.createElement('path', {
                                                                        fill: '#FEFEFE',
                                                                        d:
                                                                            'M17.277 20.192l-3.69-3.953-7.227 3.953 7.943-8.47 3.802 3.99 7.152-3.99z'
                                                                    })
                                                                )
                                                            )
                                                        )
                                    ...
                                    (stepStatus[3] === 'completed' || stepStatus[3] === 'failed') &&
                                        _react.default.createElement(
                                            ...
                                            _react.default.createElement(
                                                ...
                                                tipio && tipio.meta && tipio.meta.tipo_offer_company_name,
                                                ' leverer varen til deg! Ta kontakt med leverand\xF8r for sp\xF8rsm\xE5l.'
                                            )
                                        )
                                )
                            )
...
VerticalTimeline.propTypes = {
    ...
    tipio: _propTypes.default.arrayOf(
