    ...
    return (
        <>
            <a className="emptyCover" href="">
                ...
                <span className="emptyCover--text">Last opp logo</span>

                <svg className="emptyCover--add" width={32} height={32}>
                    <defs>
                        <path
                            id="prefix__a"
                    ...
                    <g fill="none" fillRule="evenodd">
                        <circle cx={16} cy={16} r={16} fill="#4ABCAC" />
                        <g transform="translate(9.92 9.92)">
                            <mask id="prefix__b" fill="#fff">
                                <use xlinkHref="#prefix__a" />
                            </mask>
                            <use fill="#8C8F91" fillRule="nonzero" xlinkHref="#prefix__a" />
                            <g fill="#381B81" mask="url(#prefix__b)">
                                <path d="M-17.92-1.92h32v32h-32z" />
                            </g>
                        </g>
                    </g>
                </svg>
