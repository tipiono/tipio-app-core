...
const OrderFilters = (props) => {
    const [title, setTitle] = useState('Leveringsstatus');
    useEffect(() => {
    ...
    return (
        <>
            <div className="orderFilters">
                {!props.dontShowOrderUpdate && (
                    <div className="orderFilters--dropdown">
                        <div className={cx('orderFilters--dropdown__content', { orderFilters__active: props.visible })}>
                            <span className="orderFilters--dropdown--icon">
                            ...
                            <DropDown title={title} {...props} showCloseIcon>
                                <DropDownItem>
                                    <a
                                        href="/"
                                        onClick={(e) => {
                ...
                <div className="orderFilters__addrese w-25">Adresse</div>
                <div className="w-28">
                    <a
                        className={cx('orderFilters--sort lastElement', { active: props.order_by === 'zip_code' })}
                        href=""
                        onClick={(e) => {
                            e.preventDefault();
