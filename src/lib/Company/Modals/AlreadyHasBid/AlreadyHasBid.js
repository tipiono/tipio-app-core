...
const AlreadyHasBid = (props) => {
    return (
        <>
            <Modal showCloseButton={!props.isLoading} {...props} onCloseButtonClick={props.onCloseButtonClick}>
                <div className="alreadyHasBid">
                    ...
                    <p className="alreadyHasBid--description">
                        En annen bedrift har akkurat sendt inn et bud på dette <br /> produkte. Budet ditt ble derfor
                        dessverre ikke sendt inn.{' '}
                    </p>
