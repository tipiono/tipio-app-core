    ...
    return (
        <div className="companyAddBidCard">
            <CompanySidebarBaseCard {...props}>
                {props.loading ? (
                    <div className="placeholder-content companyAddBidCard--placeholder mb-4">&nbsp;</div>
                ) : (
                    <h6 className="companyAddBidCard--interested">
                        {meta.joined_count} {showBindingCount ? 'kjøpte!' : 'påmeldte!'}
                    </h6>
                )}
