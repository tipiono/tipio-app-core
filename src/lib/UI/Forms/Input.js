...
export default React.forwardRef(
    ({ placeholder, name, errors, displayErrors, onBlur, disabled = false, ...props }, ref) => (
        <>
            <label
                className={cx('pure-material-textfield-outlined ', {
                    validationError: errors && errors[name],
                    disabled__input: disabled
                })}
            >
                <input placeholder=" " id={props.id || name} name={name} {...props} ref={ref} disabled={disabled} />
