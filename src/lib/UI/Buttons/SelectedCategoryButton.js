...
const SelectedCategoryButton = ({ onClick, title, isSelected }) => {
    return (
                ...
                {isSelected ? (
                    <svg width={25} height={25} viewBox="0 0 25 25" fill="none">
                        <g fill="#8C8F91" fillRule="nonzero" stroke="#8C8F91" strokeWidth={0.6}>
                            <path d="M23 12.5C23 6.701 18.299 2 12.5 2S2 6.701 2 12.5 6.701 23 12.5 23 23 18.299 23 12.5zm-20 0a9.5 9.5 0 1119 0 9.5 9.5 0 01-19 0z" />
                            ...
                            <path d="M12.5 11.756l2.602-2.602a.526.526 0 01.744.744L13.244 12.5l2.602 2.602a.526.526 0 01-.744.744L12.5 13.244l-2.602 2.602a.526.526 0 01-.744-.744l2.602-2.602-2.602-2.602a.526.526 0 11.744-.744l2.602 2.602z" />
                        </g>
                    </svg>
                ) : (
