                            ...
                            <div className="col-sm-12 col-md-11 mx-auto">
                                <div className="row">
                                        ...
                                        <div className="customFooter__list">
                                            ...
                                            <ul className="customFooter__list__content">
                                                <li><a className="customFooter__list__content__link"
                                                    href="https://goo.gl/maps/UdKQacRovy4guaYW9" target="_blank">Møllergata 4,0179 Oslo</a></li>
                                                <li><a className="customFooter__list__content__link"
                                                    href="tel:+47 987 65 456">+47987 65 456</a></li>
                                                <li><a className="customFooter__list__content__link"
                                    ...
                                    <div className="col-sm-12 col-md-6">
                                        <p className="customFooter__description">Hvorfor kjøpe dyrt alene når vi kan handle billig sammen?
                                            <br />
                                            <p></p>
