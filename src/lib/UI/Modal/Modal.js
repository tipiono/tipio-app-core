...
// import CloseDark from '../../static/assets/images/close-dark.svg';
...
class Modal extends Component {
    ...
    render() {
        ...
        const clsList = `modal-dialog modal-dialog-scrollable ${appendCenteredClass ? 'modal-dialog-centered' : ''} ${type}`;
        return (
            <>
