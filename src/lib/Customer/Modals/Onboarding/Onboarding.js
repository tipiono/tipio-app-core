    ...
    return (
        <>
            <Modal showCloseButton>
                <div className="joinTipioOnboarding">
                    ...
                    >
                        {
                            steps.map((step) => {
                                return (
                                    <div className="">
                                        <div className="joinTipioOnboarding--image">{step.icon()}</div>
                                        <h4 className="joinTipioOnboarding--title">{step.title} </h4>
                                        <div className="joinTipioOnboarding--action">
                                            <SecondaryButton text={step.buttonText} onClick={_setActive}/>
                                        </div>
                                    </div>
                                )
                            })
                    ...
                    <ul className="joinTipioOnboarding--indicators">
                        {steps.map((s, i) => (
                            <li className={cx("joinTipioOnboarding--indicators--item", {active: i === active})} />
                        ))}
                    </ul>
                </div>
            </Modal>
