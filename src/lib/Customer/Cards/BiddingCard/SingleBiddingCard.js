            ...
            <div className="singleBiddingCard__body">
                <div className="singleBiddingCard__body--content">
                    <a onClick={onClick} href="/">
                        <h2 className="singleBiddingCard__body--content--title">
                            {title}
                        </h2>
                    </a>
                    {brand &&
                ...
                <div className="singleBiddingCard__body--price">
                    ...
                    <h3 className="singleBiddingCard__body--price--sale">{generatePrice(bindingCount, firstRange, secondRange)} Kr</h3>
                </div>
